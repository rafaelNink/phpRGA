...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Pessoas / Edit #{{$pessoa->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('pessoas.update', $pessoa->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('nome')) has-error @endif">
                    ...
                    <input type="text" id="nome-field" name="nome" class="form-control" value="{{ is_null(old("nome")) ? $pessoa->nome : old("nome") }}"/>
                       @if($errors->has("nome"))
                    ...
                    <input type="text" id="endereco-field" name="endereco" class="form-control" value="{{ is_null(old("endereco")) ? $pessoa->endereco : old("endereco") }}"/>
